...
export const meta = {
  title: 'Barnabus - Multi Purpose Discord Bot',
  description:
  ...
  image: logoBarnabus,
  feat_position: 3,
  tags: ['side project', 'bot', 'discord', 'typescript', 'mongodb'],
}
