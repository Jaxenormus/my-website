...
import logoTwilid from '@/public/assets/logos/twilid.png'
...
export const meta = {
  title: 'A calendar app helping business improve retention',
  description:
    'Twilid is an calendar app designed specifically for business owners with audiences. It helps them keep their members engaged with their events through a feature-packed calendar, providing them with a direct communication channel to relay important events and information.',
  feat_position: 1,
  image: logoTwilid,
  links: [
    {
